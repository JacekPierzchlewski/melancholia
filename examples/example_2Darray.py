...
if __name__ == '__main__':
    ...
    strInfo \
        = "The simplest example of 2D array printing (vertical array): \n\n"
    ...
    strInfo \
        = "2D array printing with integer format and custom delimiter: \n\n"
    ...
    strInfo = "2D array printing with integer format, "
    strInfo += "custom delimiter and array header: \n\n"
    mA = np.random.rand(10, 10)
    strPrintedMat = \
        strInfo + melancholia.printA(mA, strFormat='%.2f', strDelimiter='...',
    ...
    mA = np.random.rand(10, 20)
    strPrintedMat = strInfo + melancholia.printA(mA, iMaxCols=109,
                                                 strDelimiter=' <---> ')
    hReport.write(strPrintedMat)

    # The maximum number of characters in a single line,
    # no spearation between the lines
    strInfo = "Wrap line printing after 120 characters, "
    strInfo += "no separation between the lines: \n\n"
    ...
    # The maximum number of characters in a single line,
    # no spearation between the lines, no separation between the rows
    strInfo = "Wrap line printing after 120 characters, no separation "
    strInfo = "between the lines, no separation between the rows: \n\n"

    mA = np.random.rand(10, 20)
    strPrintedMat = strInfo + melancholia.printA(mA, iMaxCols=109,
                                                 iLineSpaces=0, iRowSpaces=0)
    hReport.write(strPrintedMat)
